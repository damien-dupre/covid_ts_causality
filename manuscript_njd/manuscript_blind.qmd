...
The data can be accessed from the COVerAGE-DB OSF repository (https://osf.io/mpwjq/), from the Oxford Covid-19 Government Response Tracker (OxCGRT) "covid-policy-dataset" GitHub repository (https://github.com/OxCGRT/covid-policy-dataset), and from the UNESCO servers (https://en.unesco.org/file/unesco-data-school-closures-february-2020-june-2022csv-zip). All preprocessing, analyses and code used to build the submitted paper are available at https://github.com/[hidden for anonymous peer-review].
