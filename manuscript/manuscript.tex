...
\urlstyle{same}
\hypersetup{
  pdftitle={Divergent Impacts of COVID-19 School Closures on Youth Infection Dynamics: Evidence from 12 European Countries},
  pdfauthor={Anonymous Authors},
  pdfkeywords={COVID-19, School closures, Intergenerational
...
\citep{who2022https} reveals perfect similarities. The original data
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-overall-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-descriptive-1.png}}
...
decisions. Source: \citep{unesco2022https}.}
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-age-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{fig-country-1.png}}
...
\includegraphics[width=17.1875in,height=\textheight,keepaspectratio]{fig-te-1.png}
...
observations from \citep{alfano2022effects} while providing a clearer
