...
knit: (function(input, ...) {
    rmarkdown::render(
      ...
      output_file = glue::glue("{xfun::sans_ext(input)}.pdf"),
      envir = globalenv()
    )
  })
---
